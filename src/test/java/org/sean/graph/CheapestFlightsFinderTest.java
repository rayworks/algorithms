...
public class CheapestFlightsFinderTest {

    private CheapestFlightsFinder finder;

    @Before
    public void setUp() throws Exception {
        finder = new CheapestFlightsFinder();
    }

    @Test
    public void findCheapestPrice() {
        int price = finder.findCheapestPrice(15,
                new int[][]{
